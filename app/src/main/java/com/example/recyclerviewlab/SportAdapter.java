...
import butterknife.ButterKnife; import com.bumptech.glide.Glide;
import com.example.recyclerviewlab.BaseViewHolder;

import java.util.List; public class SportAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     ...
     public void addItems(List<Sport> sportList) {
        mSportList.addAll(sportList); notifyDataSetChanged();     }
     public interface Callback { void onEmptyViewRetryClick(); }
     public class ViewHolder extends BaseViewHolder {
        @BindView(R.id.thumbnail) ImageView coverImageView;
        @BindView(R.id.title) TextView titleTextView;
        @BindView(R.id.newsTitle) TextView newsTextView;
        @BindView(R.id.newsInfo) TextView infoTextView;
        public ViewHolder(View itemView) {
            ...
            if (mSport.getImageUrl() != null) {
                Glide.with(itemView.getContext()) .load(mSport.getImageUrl()) .into(coverImageView); }
        ...
        @BindView(R.id.buttonRetry) TextView buttonRetry;
