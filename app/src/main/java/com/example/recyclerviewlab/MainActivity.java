...
public class MainActivity extends AppCompatActivity implements SportAdapter.Callback{
    ...
    private void setUp(){
        ...
        mSportAdapter = new SportAdapter(new ArrayList<>()); prepareDemoContent();
    }

    private void prepareDemoContent() {
        CommonUtils.showLoading(MainActivity.this);
        new Handler().postDelayed(() -> { //prepare data and show loading
            ...
            mRecyclerView.setAdapter(mSportAdapter); }, 2000); }
